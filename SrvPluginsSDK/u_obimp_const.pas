...
const
  ...
  OBIMP_DEF_ACCOUNT_NAME_LEN     = 255;
  OBIMP_MAX_ACC_NAME_LEN         = 1024;
  ...
  OBIMP_BEX_PRES  = $0003; OBIMP_BEX_PRES_VER_MAJOR =  1; OBIMP_BEX_PRES_VER_MINOR =  4;
  ...
  OBIMP_BEX_PRES_MAX                  = OBIMP_BEX_PRES_SRV_PRES_INFO;
  ...
  CL_MAX_GROUPS_COUNT      = 4000;
  CL_MAX_GROUP_NAME_LEN    = 512;
  CL_MAX_CONTACTS_COUNT    = 8000;
  CL_MAX_CONTACT_NAME_LEN  = 512;
